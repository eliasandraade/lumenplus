...
// Retorno tipado como Uint8Array<ArrayBuffer> — e nao o Uint8Array generico.
// A partir do TS 5.7 o Uint8Array e generico no tipo do buffer, e o padrao
// (ArrayBufferLike) inclui SharedArrayBuffer, que nao satisfaz o BufferSource
// exigido por applicationServerKey. Alocar o ArrayBuffer explicitamente fixa o
// parametro e mantem a chave VAPID aceita pelo PushManager.
